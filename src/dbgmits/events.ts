...
/**
  * Emitted when a debugger is started
  *
  ...
  * @event
  */
export const EVENT_SESSION_STARTED: string = 'sess_started';
...
export function createEventForAsyncNotification(notification: string, data: any): IDebugSessionEvent|undefined {
  switch (notification) {
